...
use Fortifi\Api\V1\Payloads\ApplyOfferSubscriptionPayload;
...
class CustomersCustomerFidSubscriptionsSubscriptionFidEndpoint extends ApiEndpoint
{
   ...
   * @summary Apply an offer to a subscription
   *
   * @param ApplyOfferSubscriptionPayload $payload
   *
   * @return ApiRequest
   */
  public function setApplyOffer(ApplyOfferSubscriptionPayload $payload)
  {
    $request = new ApiRequest();
    $request->setConnection($this->_getConnection());
    $request->setEndpoint($this);
