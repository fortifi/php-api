...
class CustomersCustomerFidPaymentsPaymentFidChargebackEndpoint extends ApiEndpoint
{
  protected $_path = 'customers/{customerFid}/payments/{paymentFid}/chargeback';
   ...
   * @return FidRequest
   */
  public function create($dateSubmitted, $reasonCode, $caseNumber, $amount, $state, $source, $refunded, $description = null, $feeCurrency = null, $feeAmount = null)
  {
