  ...
  implements \JsonSerializable
{
   ...
   * @param mixed $default
   *
   * @return CancelFunnelStepRequest
   */
   ...
   * @param mixed $default
   *
   * @return CancelFunnelDecisionRequest[]
   */
  ...
  protected function _prepareResult($result)
  {
    ...
    {
      $return->stepData = (new CancelFunnelStepRequest())
    ...
    if(!empty($return->choices))
    {
      ...
      {
        $return->choices[$itmKey] = (new CancelFunnelDecisionRequest())
          ->hydrate($itm);
      }
    }
